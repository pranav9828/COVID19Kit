...
import com.corona.covid_19explorer.ApiClient;
import com.corona.covid_19explorer.ApiInterface;
import com.corona.covid_19explorer.Model.Articles;
import com.covid.covid_19explorer.Model.News;
import com.corona.covid_19explorer.NewsDetail;
    ...
    private void initListener(){
        adapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(CoronaNews.this, NewsDetail.class);
